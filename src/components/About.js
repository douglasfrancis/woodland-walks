    ...
    <div id='about' className='white'>
      ...
      <div className='flexwrap-container'>
        ...
        <div className='txt'>
          ...
          <p >My name is Angelina and I’m the owner of Woodland Dog Walks Congleton.<br/><br/>Based near Timbersbrook, Congleton, we are lucky enough to have Biddulph Valley Way and Bosley cloud on our door step.
